...
API_ID = int(os.environ.get("API_ID", "30699087"))

# Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "6b840aba040241d9a3b8d6434ea99bdd")
...
DB_URI = os.environ.get("DB_URI", "mongodb+srv://ismailzabiullah7406309116_db_user:Sjx5JFMgUNFu1P7V@cluster0.nh8n0jw.mongodb.net/?appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
